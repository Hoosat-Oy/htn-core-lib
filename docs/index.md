...
var imported = hoosatcore.PrivateKey.fromWIF(exported);
...
var p2shAddress = new hoosatcore.Address([publicKey1, publicKey2, publicKey3], 2);
```
...
var uri = new hoosatcore.URI(paymentInfo).toString();
```
