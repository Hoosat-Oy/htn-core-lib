...
var BN = hoosatcore.crypto.BN;
var Transaction = hoosatcore.Transaction;
var Signature = hoosatcore.Signature;
var Input = hoosatcore.Transaction.Input;
var Output = hoosatcore.Transaction.Output;
var PrivateKey = hoosatcore.PrivateKey;
var Script = hoosatcore.Script;
var Address = hoosatcore.Address;
var Networks = hoosatcore.Networks;
var Opcode = hoosatcore.Opcode;
var errors = hoosatcore.errors;
...
describe("Transaction", function () {
  ...
  it("fromObject with pay-to-public-key previous outputs", function () {
    ...
    tx.inputs[0].should.be.instanceof(hoosatcore.Transaction.Input.PublicKey);
  ...
  describe("change address", function () {
    ...
    it("adds no fee if no change is available", function () {
      var transaction = new Transaction().from(simpleUtxoWith100000Satoshis).to(toAddress, 99000).sign(privateKey);
  ...
  describe("checked serialize", function () {
    ...
    it("fails when outputs and fee don't add to total input", function () {
      var transaction = new Transaction().from(simpleUtxoWith1BTC).to(toAddress, 99900000).fee(99999).sign(privateKey);
      expect(function () {
        return transaction.serialize();
    ...
    describe("skipping checks", function () {
      ...
      it(
        ...
        buildSkipTest(
          function (transaction) {
            return transaction.to(toAddress, 100).change(changeAddress).sign(privateKey);
          },
          "disableDustOutputs",
  ...
  describe("checks on adding inputs", function () {
    ...
    it("will add an empty script if not supplied", function () {
      ...
      transaction.inputs[0].output.script.should.be.instanceof(hoosatcore.Script);
  ...
  describe("inputAmount + outputAmount", function () {
    ...
    it("returns correct values for transaction with change", function () {
      var transaction = new Transaction().from(simpleUtxoWith1BTC).change(changeAddress).to(toAddress, 1000);
      transaction.inputAmount.should.equal(100000000);
