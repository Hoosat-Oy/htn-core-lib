...
var BufferWriter = hoosatcore.encoding.BufferWriter;
var BufferReader = hoosatcore.encoding.BufferReader;
...
describe("Output", function () {
  ...
  it("#toObject roundtrip will handle an invalid (null) script", function () {
    ...
    var br = new hoosatcore.encoding.BufferReader(invalidOutputScript);
