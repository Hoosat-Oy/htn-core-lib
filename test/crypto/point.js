...
var Point = hoosatcore.crypto.Point;
...
describe("Point", function () {
  ...
  describe("#add", function () {
    it("should accurately add g to itself", function () {
      ...
      p3.getX()
        .toString()
        .should.equal("89565891926547004231252920425935692360644145829622209" + "833684329913297188986597");
      p3.getY()
        .toString()
        .should.equal("12158399299693830322967808612713398636155367887041628" + "176798871954788371653930");
    });
  });
  ...
  describe("#mul", function () {
    it("should accurately multiply g by 2", function () {
      ...
      b.getX()
        .toString()
        .should.equal("8956589192654700423125292042593569236064414582962220983" + "3684329913297188986597");
      b.getY()
        .toString()
        .should.equal("1215839929969383032296780861271339863615536788704162817" + "6798871954788371653930");
    });
    ...
    it("should accurately multiply g by n-1", function () {
      ...
      b.getX()
        .toString()
        .should.equal("55066263022277343669578718895168534326250603453777594175" + "500187360389116729240");
      b.getY()
        .toString()
        .should.equal("83121579216557378445487899878180864668798711284981320763" + "518679672151497189239");
    });
    ...
    it("should accurately multiply g by n+1", function () {
      ...
      b.getX()
        .toString()
        .should.equal("550662630222773436695787188951685343262506034537775941755" + "00187360389116729240");
      b.getY()
        .toString()
        .should.equal("326705100207588169780830851305070431844712733806592432759" + "38904335757337482424");
    });
  });
