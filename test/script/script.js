...
var BufferUtil = hoosatcore.util.buffer;
var Script = hoosatcore.Script;
var Networks = hoosatcore.Networks;
var Opcode = hoosatcore.Opcode;
...
describe("Script", function () {
  ...
  describe("#isPublicKeyIn", function () {
    it("correctly identify scriptSig as a public key in", function () {
      ...
      var script = hoosatcore.Script.fromBuffer(scriptBuffer);
  ...
  describe("#add and #prepend", function () {
    ...
    it("should add and prepend correctly", function () {
      Script().add("OP_1").prepend("OP_2").add("OP_3").prepend("OP_4").toString().should.equal("OP_4 OP_2 OP_1 OP_3");
    });
  ...
  describe("#buildPublicKeyHashOut", function () {
    it("should create script from livenet address", function () {
      var address = Address.fromString("hoosat:qrk2ulgf99rm0mjfnr39f2jgjqxjd5kwr5rfyamw2k");
      ...
      s.toAddress().toString().should.equal("hoosat:qrk2ulgf99rm0mjfnr39f2jgjqxjd5kwr5rfyamw2k");
    });
  ...
  describe("#findAndDelete", function () {
    it("should find and delete this buffer", function () {
      Script("OP_RETURN 2 0xf0f0").findAndDelete(Script("2 0xf0f0")).toString().should.equal("OP_RETURN");
    });
    it("should do nothing", function () {
      Script("OP_RETURN 2 0xf0f0").findAndDelete(Script("2 0xffff")).toString().should.equal("OP_RETURN 2 0xf0f0");
    });
  });
  ...
  describe("getData returns associated data", function () {
    ...
    it("for a P2SH address", function () {
      var address = Address.fromString("hoosat:pzjt8lxnl977xtexlycnl5fyt0al9gcnauyjtqh68n");
  ...
  describe("toAddress", function () {
    ...
    it("for a P2PKH address", function () {
      var stringAddress = "hoosat:qrk2ulgf99rm0mjfnr39f2jgjqxjd5kwr5rfyamw2k";
      var address = new Address(stringAddress);
      var script = new Script(address);
      script.toAddress().toString().should.equal(stringAddress);
    });
    it("for a P2SH address", function () {
      var stringAddress = "hoosat:pzjt8lxnl977xtexlycnl5fyt0al9gcnauyjtqh68n";
      var address = new Address(stringAddress);
      var script = new Script(address);
      script.toAddress().toString().should.equal(stringAddress);
    });
    ...
    it("works for p2pkh output", function () {
      ...
      script.toAddress().toString().should.equal("hoosat:qrywzxcwkrf265mzmz20qjyssdql5cdkuyz47850l7");
    });
    it("works for p2pkh input", function () {
      ...
      s2.toAddress().toString().should.equal("hoosat:qprjfgyvctp82eddvwrup69dvggw63afzg0rfyyvtn");
    });
    ...
    it("works for p2sh output", function () {
      ...
      script.toAddress().toString().should.equal("hoosat:pzva9yz34uxzntwtjpqqx36jhwnamce7x5whc9x70h");
    });
    it("works for p2sh input", function () {
      ...
      script.toAddress().toString().should.equal("hoosat:pz30sxmypnge5lv0eyshlt0w5jzu5axu3sl4r37aun");
    });
  ...
  describe("#getSignatureOperationsCount", function () {
    ...
    it("should handle P2SH-multisig-in scripts from utility", function () {
      ...
      var signature = hoosatcore.crypto.Signature.fromString("30060201FF0201FF");
