...
[
	...
	"hoosat:qqnash4vvcpx3s4qrf47p3rkcd4230sxz7506ejpt4gkpm2fh9xsumafqp07p",
	"hoosat:qqwxqxwc0w54vsxlwyzt74enqq4e7d6mjp99l3te48r6ak4auehnqzae9a6uw",
	"hoosat:qztdywdh8d9zjztdn8kdvckgch0e8p47gendyzks3lx2n8r70hktujwsy6ums",
	"hoosat:qr0we0jumdfr25wpp9her3lk4nere24jmsfvew4z6gfwrj3dhhpny89xs7g6j",
	"hoosat:qpdpduavrg6j39e8dn6rsr68yu4p6x6ju695up0p4r4gay0wymm4cged8p758"
].map(addr=>{
...
Transaction.prototype.checkedSerialize = function (opts) {
  ...
  if (serializationError) {
    serializationError.message +=
      " - For more information please see: " + "https://hoosatcore.io/api/lib/transaction#serialization-checks";
 ...
 * and a slightly fancier format recognized by hoosatcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a hoosatcore Address object. The
 * same is true for `script`, which can be a string or a hoosatcore Script.
 *
...
Transaction.prototype.from = function (utxo, pubkeys, threshold, opts) {
  if (JSUtil.debugLevel == logLevels.debug) console.log("Transaction:from utxo:", utxo);
  if (_.isArray(utxo)) {
    var self = this;
...
Transaction.prototype.getSignatures = function (privKey, sigtype, signingMethod) {
  ...
  let sigs,
    list = this.inputMap.get(address) || [];
