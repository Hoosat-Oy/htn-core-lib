 ...
 *
 * @param {string} prefix Network prefix. E.g.: 'hoosattest'.
 */
...
var dnsSeeds = ["mainnet-node-1.hoosat.fi"];
...
const hoosatNetworks = ["hoosat-mainnet", "hoosat-devnet", "hoosat-regtest", "hoosat-testnet", "hoosat-simnet"];

hoosatNetworks.map((str) => {
  addNetwork({
    name: str,
    prefix: str,
    pubkeyhash: 0x00, // publickey hash prefix
    privatekey: 0x80, // privatekey prefix -- must be 128 or toWIF() result will not match with hoosat
    scripthash: 0x05,
...
module.exports = {
  ...
  defaultNetwork: "hoosat-mainnet",
  livenet: "hoosat-mainnet",
  mainnet: "hoosat-mainnet",
  "hoosat-mainnet": "hoosat-mainnet",
  "hoosat-devnet": "hoosat-devnet",
  "hoosat-regtest": "hoosat-regtest",
  "hoosat-testnet": "hoosat-testnet",
  "hoosat-simnet": "hoosat-simnet",
  testnet: "hoosat-testnet",
  regtest: "hoosat-regtest",
  get: get,
